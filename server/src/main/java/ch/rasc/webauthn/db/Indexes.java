...
public class Indexes {
    ...
    private static class Indexes0 {
        ...
        public static Index CONSTRAINT_INDEX_9 = Internal.createIndex("CONSTRAINT_INDEX_9", Credentials.CREDENTIALS, new OrderField[] { Credentials.CREDENTIALS.APP_USER_ID }, false);
        public static Index PRIMARY_KEY_9 = Internal.createIndex("PRIMARY_KEY_9", Credentials.CREDENTIALS, new OrderField[] { Credentials.CREDENTIALS.ID, Credentials.CREDENTIALS.APP_USER_ID }, true);
    }
}

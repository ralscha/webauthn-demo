...
public class AppUser extends TableImpl<AppUserRecord> {
     ...
     */
    public final TableField<AppUserRecord, String> USERNAME = createField("USERNAME", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>APP_USER.RECOVERY_TOKEN</code>.
     */
    public final TableField<AppUserRecord, byte[]> RECOVERY_TOKEN = createField("RECOVERY_TOKEN", org.jooq.impl.SQLDataType.VARBINARY, this, "");

    /**
     * The column <code>APP_USER.REGISTRATION_START</code>.
     */
    public final TableField<AppUserRecord, LocalDateTime> REGISTRATION_START = createField("REGISTRATION_START", org.jooq.impl.SQLDataType.LOCALDATETIME, this, "");

    /**
     * The column <code>APP_USER.REGISTRATION_ADD_START</code>.
     */
    public final TableField<AppUserRecord, LocalDateTime> REGISTRATION_ADD_START = createField("REGISTRATION_ADD_START", org.jooq.impl.SQLDataType.LOCALDATETIME, this, "");

    /**
     * The column <code>APP_USER.REGISTRATION_ADD_TOKEN</code>.
     */
    public final TableField<AppUserRecord, byte[]> REGISTRATION_ADD_TOKEN = createField("REGISTRATION_ADD_TOKEN", org.jooq.impl.SQLDataType.VARBINARY, this, "");

...
public class AppUserRecord extends UpdatableRecordImpl<AppUserRecord> implements Record6<Long, String, byte[], LocalDateTime, LocalDateTime, byte[]> {
     ...
     */
    @Override
    public AppUserRecord values(Long value1, String value2, byte[] value3, LocalDateTime value4, LocalDateTime value5, byte[] value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AppUserRecord(Long id, String username, byte[] recoveryToken, LocalDateTime registrationStart, LocalDateTime registrationAddStart, byte[] registrationAddToken) {
        super(AppUser.APP_USER);
